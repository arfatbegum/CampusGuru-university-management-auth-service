...
const createDepartmentFromEvent = (e) => __awaiter(void 0, void 0, void 0, function* () {
    const academicFaculty = yield academicFaculty_model_1.AcademicFaculty.findOne({ syncId: e.academicFacultyId });
    const payload = {
        title: e.title,
...
const updateDepartmentFromEvent = (e) => __awaiter(void 0, void 0, void 0, function* () {
    const academicFaculty = yield academicFaculty_model_1.AcademicFaculty.findOne({ syncId: e.academicFacultyId });
    const payload = {
        title: e.title,
        academicFaculty: academicFaculty === null || academicFaculty === void 0 ? void 0 : academicFaculty._id
...
const deleteDepartmentFromEvent = (syncId) => __awaiter(void 0, void 0, void 0, function* () {
