...
const updateStudent = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(student_constants_1.EVENT_STUDENT_UPDATED, JSON.stringify(result));
    }
    return result;
});
const deleteStudent = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        session.endSession();
        if (student) {
            yield redis_1.RedisClient.publish(student_constants_1.EVENT_STUDENT_DELETED, JSON.stringify(student));
        }
        return student;
    }
    catch (error) {
