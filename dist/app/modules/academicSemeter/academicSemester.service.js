...
const createSemesterFromEvent = (e) => __awaiter(void 0, void 0, void 0, function* () {
    yield academicSemester_model_1.AcademicSemester.create({
        title: e.title,
        year: e.year,
        code: e.code,
...
const updateOneIntoDBFromEvent = (e) => __awaiter(void 0, void 0, void 0, function* () {
    yield academicSemester_model_1.AcademicSemester.findOneAndUpdate({ syncId: e.id }, {
        $set: {
            title: e.title,
            year: e.year,
            code: e.code,
...
const deleteOneFromDBFromEvent = (syncId) => __awaiter(void 0, void 0, void 0, function* () {
    yield academicSemester_model_1.AcademicSemester.findOneAndDelete({ syncId });
});
