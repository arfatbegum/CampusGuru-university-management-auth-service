...
const createDepartment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(managementDepartment_constants_1.EVENT_MANAGEMENT_DEPARTMENT_CREATED, JSON.stringify(result));
    }
    return result;
});
...
const updateDepartment = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(managementDepartment_constants_1.EVENT_MANAGEMENT_DEPARTMENT_UPDATED, JSON.stringify(result));
    }
    return result;
});
const deleteDepartment = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(managementDepartment_constants_1.EVENT_MANAGEMENT_DEPARTMENT_DELETED, JSON.stringify(result));
    }
    return result;
});
