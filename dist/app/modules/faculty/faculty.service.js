...
const updateFaculty = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(faculty_constants_1.EVENT_FACULTY_UPDATED, JSON.stringify(result));
    }
    return result;
});
const deleteFaculty = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        session.endSession();
        if (faculty) {
            yield redis_1.RedisClient.publish(faculty_constants_1.EVENT_FACULTY_DELETED, JSON.stringify(faculty));
        }
        return faculty;
    }
    catch (error) {
