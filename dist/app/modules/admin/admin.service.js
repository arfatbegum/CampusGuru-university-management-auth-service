...
const updateAdmin = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(admin_constants_1.EVENT_ADMIN_UPDATED, JSON.stringify(result));
    }
    return result;
});
const deleteAdmin = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        session.endSession();
        if (admin) {
            yield redis_1.RedisClient.publish(admin_constants_1.EVENT_ADMIN_DELETED, JSON.stringify(admin));
        }
        return admin;
    }
    catch (error) {
