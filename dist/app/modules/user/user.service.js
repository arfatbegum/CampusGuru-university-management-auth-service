...
const academicSemester_model_1 = require("../academicSemeter/academicSemester.model");
...
const createAdmin = (admin, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (newUserAllData) {
        yield redis_1.RedisClient.publish(user_constant_1.EVENT_ADMIN_CREATED, JSON.stringify(newUserAllData.faculty));
    }
    return newUserAllData;
});
exports.UserService = {
