...
const createFacultyFromEvent = async (e: AcademicFacultyCreatedEvent): Promise<void> => {
...
const updateFacultyFromEvent = async (e: AcademicFacultyUpdatedEvent): Promise<void> => {
